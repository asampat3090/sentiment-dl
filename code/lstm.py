...
def get_dataset(name):
    ...
    load_data - the function to load the dataset specified
    prepare_data - the function to load the dataset specified
...
def build_set_from_sentences():
    """
    build a model as in train, test, val from a list of sentences
    """
    pass
